const stockProductos = [
  ...
  //    event.preventDefault();
     ...
     const templateID = 'template_0o17r6e';
...
document.addEventListener('DOMCnotentLoaded', () => {
    carrito = JSON.parse(localStorage.getItem('carrito')) || []
...
const mostrarCarrito = () => {
    ...
    carritoContenedor.textContent = carrito.lenght
